<%@ Page Title="" Language="C#" MasterPageFile="~/ClientMasterPage.master" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="_Default" %>
        ...
        <div class="company-logos text-center">
          <div class="row logos">
            <div class="col-lg-2 col-md-3 col-sm-4 col-6 pl-lg-0">
              <img src="src/assets/images/logo1.png" alt="" class="img-fluid">
            </div>
            <div class="col-lg-2 col-md-3 col-sm-4 col-6 pl-lg-0">
              <img src="src/assets/images/logo2.png" alt="" class="img-fluid">
            </div>
            <div class="col-lg-2 col-md-3 col-sm-4 col-6 mt-sm-0 mt-4 pl-lg-0">
              <img src="src/assets/images/logo3.png" alt="" class="img-fluid">
            </div>
            <div class="col-lg-2 col-md-3 col-sm-4 col-6 mt-md-0 mt-4 pl-lg-0">
              <img src="src/assets/images/logo4.png" alt="" class="img-fluid">
            </div>
            <div class="col-lg-2 col-md-3 col-sm-4 col-6 mt-lg-0 mt-4 pl-lg-0">
              <img src="src/assets/images/logo5.png" alt="" class="img-fluid">
            </div>
            <div class="col-lg-2 col-md-3 col-sm-4 col-6 mt-lg-0 mt-4 pl-lg-0">
              <img src="src/assets/images/logo1.png" alt="" class="img-fluid">
            </div>
        ...
        <div class="row">
          <div class="col-lg-5 left-wthree-img pr-lg-4">
            <div class="imgw3l-ab mb-md-5 mb-3">
              <img src="src/assets/images/ab1.jpg" alt="" class="radius-image img-fluid">
            </div>
          </div>
    ...
    <div class="container py-md-5 py-2">
      ...
      <div class="row whybox-wrap">
        ...
        <div class="col-lg-6 whybox-wrap-img pl-lg-5 mt-lg-0 mt-4">
          <div class="imgw3l-ab mb-md-5 mb-3">
            <img src="src/assets/images/ab2.jpg" alt="" class="radius-image img-fluid">
          </div>
        </div>
    ...
    <div class="container py-md-5 py-2">
      ...
      <div class="row whybox-wrap">
        <div class="col-lg-6 whybox-wrap-img pr-lg-5">
          <div class="imgw3l-ab mb-md-5 mb-3">
            <img src="src/assets/images/ab3.jpg" alt="" class="radius-image img-fluid">
          </div>
        </div>
    ...
    <div class="container py-md-5 py-2">
      ...
      <div class="row w3l-galprojects no-gutters">
        <div class="col-md-6 galprojects-gd mt-md-0 mt-5">
          <div class="galprojects-gd-content">
            <div class="crd crd--effect-3">
              <div class="crd-img" style="background-image:url(src/assets/images/1.jpg);background-position:bottom;"></div>
        ...
        <div class="col-md-6 galprojects-gd mt-md-0 mt-5">
          <div class="galprojects-gd-content">
            <div class="crd crd--effect-3">
              <div class="crd-img" style="background-image:url(src/assets/images/2.jpg);background-position:bottom;"></div>
              <div class="crd-info text-left">
        ...
        <div class="col-md-6 galprojects-gd mt-5">
          <div class="galprojects-gd-content">
            <div class="crd crd--effect-3">
              <div class="crd-img" style="background-image:url(src/assets/images/3.jpg);background-position:bottom;"></div>
              <div class="crd-info text-left">
        ...
        <div class="col-md-6 galprojects-gd mt-5">
          <div class="galprojects-gd-content">
            <div class="crd crd--effect-3">
              <div class="crd-img" style="background-image:url(src/assets/images/4.jpg);background-position:center;"></div>
              <div class="crd-info text-left">
            ...
            <div class="item">
              <div class="testimonial-content">
                <div class="testimonial">
                  ...
                  <div class="testi-des">
                    <div class="test-img">
                      <img src="src/assets/images/team1.jpg" class="img-fluid" alt="client-img">
                    </div>
                    <div class="peopl">
                      <h3>Dennis wilson</h3>
            ...
            <div class="item">
              <div class="testimonial-content">
                <div class="testimonial">
                  ...
                  <div class="testi-des">
                    <div class="test-img"><img src="src/assets/images/team2.jpg" class="img-fluid" alt="client-img">
                    </div>
                    <div class="peopl">
                      <h3>Tommy sakura</h3>
                      <p class="indentity">Customer </p>
            ...
            <div class="item">
              <div class="testimonial-content">
                <div class="testimonial">
                  ...
                  <div class="testi-des">
                    <div class="test-img"><img src="src/assets/images/team3.jpg" class="img-fluid" alt="client-img">
                    </div>
                    <div class="peopl">
                      <h3>Roy Linderson</h3>
                      <p class="indentity">Customer </p>
      ...
      <div class="row text-11">
        ...
        <div class="col-md-6 text11-content blog-grid-info text-left mt-5">
          <div class="card">
            <div class="card-header p-0 position-relative border-0">
              <a href="#">
                <img class="card-img-bottom d-block radius-image" src="src/assets/images/b3.jpg" alt="Card image cap">
              </a>
            </div>
        ...
        <div class="col-md-6 text11-content blog-grid-info text-left mt-5 pl-lg-4">
          <div class="card">
            <div class="card-header p-0 position-relative border-0">
              <a href="#">
                <img class="card-img-bottom d-block radius-image" src="src/assets/images/b4.jpg" alt="Card image cap">
              </a>
            </div>
            <div class="card-body p-0 blog-details">
              <h6 class="mt-4">May 12, 2021.</h6>
